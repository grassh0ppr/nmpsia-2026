...
const carriersData = [
  ...
  },
  {
    ...
    contact: {
      ...
      website:
        "https://www.phs.org/health-plans/employer-plans/new-mexico-public-schools-insurance-authority",
      websiteText: "Visit Website",
    },
    providerSearch: {
  ...
  },
  {
    ...
    contact: {
      ...
      website:
        "https://www.unitedconcordia.com/benefits/clients-corner/New-Mexico-Public-School-Client-Corner-Dental-Benefits",
      websiteText: "Visit Website",
    },
    providerSearch: {
  ...
  if (searchQuery && searchQuery.trim() !== "") {
    ...
    if (typeFilter && typeFilter !== "All Benefits") {
      results = results.filter((carrier) =>
        carrier.benefitTypes.some(
          (bt) => bt.toLowerCase() === typeFilter.toLowerCase(),
        ),
      );
    }
  }
